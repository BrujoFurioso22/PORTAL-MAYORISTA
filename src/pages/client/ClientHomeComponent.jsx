...
const CompanyCard = styled.div`
  border-radius: ${({ theme }) =>
    theme.borders.radius.lg}; // Corregir referencia a borders.radius
  box-shadow: ${({ theme }) =>
  ...
  &:hover {
    ...
    box-shadow: ${({ theme }) => theme.shadows.lg}; // Usar sombra del tema
  }
  ...
  ${({ theme, $hasAccess }) =>
    ...
    &:after {
      ...
      right: 0;
      bottom: 0;
      background-color: ${theme.colors.overlay}; // Usar color de overlay del tema
      color: ${theme.colors.white}; // Usar white del tema
      display: flex;
      align-items: center;
...
const CompanyLogo = styled.img`
  ...
  padding: 1rem;
  background-color: ${({ theme }) =>
    theme.colors.white}; // Fondo blanco para logos
`;
...
const CompanyInfo = styled.div`
  ...
  background-color: ${({ theme }) =>
    theme.colors.surface}; // Asegurar contraste
`;
